...
export default function Dashboard({ prompt, businessData, onLogout }) {
  ...
  // Automatically pop the insights generated by CrewAI as soon as we land on Dashboard!
  React.useEffect(() => {
    if (businessData && businessData.researchReport && !window.hasSeenInsights) {
      setActiveInsight('market');
      window.hasSeenInsights = true;
    }
  }, [businessData]);
  ...
  return (
    <div className="dashboard-layout">
                ...
                <div className="agent-header">
                  ...
                  <div style={{ display: 'flex', gap: '8px' }}>
                    ...
                    >
                      ...
                      {agentStatus === 'running' ? 'Pause' : 'Start'}
                    </button>
                  </div>
                </div>
      ...
      {isChatOpen && (
        <ChatUI 
          agentId={"autogen-custom_zippp_agent"}
